...
To conduct this project, I provide and revise the code from mini project to get the selected dataset. A new factor about month is created for conduting the following analysis. 
