...
2.  *How did the range of the extreme flow change in a year?*
3.  *What is the distribution of the maximum and minimum ofthe flow?*
4.  *Did the maximum of flow relate to month?*
    <!----------------------------------------------------------------------------->
